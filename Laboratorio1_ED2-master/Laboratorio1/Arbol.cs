            ...
            while (actual != null)
            {
                if (actual.Valores.Count == 3)
                {
                    ...
                    else
                    {
                        ...
                        int pos1 = padre.FindHijoPosition(nNodos[1].Valores[0]);
                        padre.InsertarHijo(nNodos[1]);

                        int posActual = padre.FindHijoPosition(value);
            ...
            while (curr != null)
            {
                ...
                if (curr.Valores.Count == 1)
                {
                    ...
                    { 
                        ...
                        int HijoPos = Padre.FindHijoPosition(cK);
